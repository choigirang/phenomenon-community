...
exports.galleryDeleteComment = exports.galleryEditComment = exports.galleryAddComment = exports.likesGallery = exports.deleteGallery = exports.detailGallery = exports.addImageToGallery = exports.galleryList = exports.latestGallery = void 0;
...
function deleteGallery(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (!deleteGallery)
                res.status(404).json('데이터가 존재하지 않습니다.');
