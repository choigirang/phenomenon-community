...
exports.checkUser = exports.createUser = exports.sendSecurityCode = exports.searchUserData = exports.searchUser = exports.allUser = exports.loginUser = void 0;
...
function checkUser(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (!cookie)
                return res.status(401).send('유효하지 않은 유저입니다.');
            // 토큰 확인
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (findUser.length === 0)
                return res.status(200).send('검색된 유저가 없습니다.');
...
function searchUserData(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (!findUser)
                return res.status(404).json('일치하는 유저가 존재하지 않습니다.');
            const userData = {
                id: findUser.id,
                name: findUser.name,
                img: findUser.img,
